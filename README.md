...
- **Liquidation diagnostics** — Binance markPrice / forceOrder 파싱·분석
- `OU score` 기반 라이브 스크리너, 5분 cross-sectional mean-reversion
...
- 6-mode RAG **ablation** 정량 비교 · Kaggle Jane Street(Bronze) · BTC 변동성 예측(우수상)
